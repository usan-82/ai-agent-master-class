...
class ViralityCrew:
    ...
    def virality_expert(self):
        return Agent(
            ...
            goal="Analyze social media content for viral potential and provide a strict score (0-100) with actionable feedback",
    ...
    def virality_audit(self):
        return Task(
            ...
            1. A virality score from 0-100 based on:
            ...
            - score: integer from 0-100 rating the viral potential
